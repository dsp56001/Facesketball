...
namespace Facesketball
{
    ...
    public class FloatingBall : DrawableSprite
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            //X right
            if (this.Location.X >
                    graphics.GraphicsDevice.Viewport.Width - this.locationRect.Width)
            {
                //Negate X
                this.Direction = this.Direction * new Vector2(0, 1);
                this.Location.X = graphics.GraphicsDevice.Viewport.Width - this.locationRect.Width;
            }
            ...
            //Y top
            if (this.Location.Y >
                    graphics.GraphicsDevice.Viewport.Height - this.locationRect.Height)
            {
                //Negate Y
                this.Direction = this.Direction * new Vector2(1, 0);
                this.Location.Y = graphics.GraphicsDevice.Viewport.Height - this.locationRect.Height;
            }
